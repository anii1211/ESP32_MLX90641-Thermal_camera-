...
//  MLX90641_SetRefreshRate(MLX90641_address, 0x02); //Set rate to 2Hz
  ...
  MLX90641_SetRefreshRate(MLX90641_address, 0x06); //Set rate to 32Hz effective - Works
  softWire.setClock(800000);
#endif
...
{
#ifndef USE_MLX90641
   softWire.beginTransmission((uint8_t)MLX90640_address);
#else
  softWire.beginTransmission((uint8_t)MLX90641_address);
#endif
